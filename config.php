...
class CamerticConfig {
	//var $user = 'speciav6_wmi';
	var $user = 'root';
	//var $pass = 'C05]44]_i7)2';
	var $pass = '';

	//var $library = 'C:\wamp\www\pagify\lib\library.php';
	var $dbtype = 'mysql';
	//var $host = 'mysql51-72.perso';
	var $host = '127.0.0.1';
	//var $dbname = 'speciav6_wmisport';
	var $dbname = 'htc';
	var $port = 3306;
	var $rootUrl = 'http://localhost/yghautier/WMISPORT/';
	var $appfolder = 'yghautier/WMISPORT';
