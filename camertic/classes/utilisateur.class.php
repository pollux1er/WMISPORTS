...
class utilisateur extends bd {
	...
	var $tableusers = 'membres';
	var $loginfield = 'login';
	var $passfield = 'password';
	var $statusfield = 'activated';
	...
	*/
	...
	public function simpleLogin($username, $pass) {
		...
		$requete = "SELECT * FROM $this->tableusers WHERE $this->loginfield = '$this->utilisateur' LIMIT 1;";
	...
	*/
	public function authenticateUser($ids) {
		...
		if($this->isLoggedIn == true) {
			...
			$_SESSION['u']['statut'] = 1;
			$_SESSION['u']['nom'] = $this->userDatas->name;
